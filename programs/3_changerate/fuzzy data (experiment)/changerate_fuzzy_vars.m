...
rootdir='/media/external/decor4';
    %'/Volumes/My Book/decor4';
...
runtitle='DB03-1_01_23_deepscour';
...
% Type below the number of square meters represented by a single pixel.
pixel_to_meter_scale=1; % [meters^2/pixel]
